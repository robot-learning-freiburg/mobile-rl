...
public:
    ...
    virtual bool findIkPython(const std::vector<double> &desired_gripper_tf_world, double dt, bool &in_selfcollision, double threshold);
    ...
    virtual bool findIk(const tf::Transform &desired_gripper_tf_world, double dt, bool &in_selfcollision, double threshold = 0.2);
    ...
    void reloadRobotDescription();
    double getManipulability(const std::string &joint_group);
    Eigen::MatrixXd getJacobian(const std::string &joint_group);
